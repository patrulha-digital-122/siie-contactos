...
public class ImportContactsListView extends VerticalLayout implements HasLogger
{
	...
	protected void onAttach( AttachEvent attachEvent )
	{
		...
		signin.addLoginListener( e ->
		{
			...
			getLogger().info( e.getGoogleAcessInfo().getExpires_in().toString() );
			googleAuthentication.setAccessToken( e.getGoogleAcessInfo().getAccess_token() );
			signin.setVisible( false );
		} );
		signin.addLogoutListener( () ->
		{
			showInfo( "Adeus" );
			googleAuthentication.setAccessToken( "" );
