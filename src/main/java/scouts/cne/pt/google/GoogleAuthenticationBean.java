...
public class GoogleAuthenticationBean implements Serializable, HasLogger {
	...
	public GoogleAuthorizationCodeRequestUrl getGoogleAuthorizationCodeRequestUrl(String sessionId)
			throws GeneralSecurityException, IOException {
		// TODO Auto-generated method stub
		return getGoogleAuthorizationCodeFlow().newAuthorizationUrl().setRedirectUri(getRedicetUrl())
				.setState(sessionId);
	}
		...
		try {
			TokenResponse response = new AuthorizationCodeTokenRequest(getHttpTransport(), getJsonfactry(),
					...
					.setClientAuthentication(
							new ClientParametersAuthentication(googleClientSecrets.getDetails().getClientId(),
