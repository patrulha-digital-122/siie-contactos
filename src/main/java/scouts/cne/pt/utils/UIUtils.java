...
import scouts.cne.pt.ui.util.css.Shadow;
...
public class UIUtils {
	...
	public static FlexLayout createPhoneLayout() {
		...
		number.setValue( "getPhoneNumber()" );
	...
	public static Image createAvatar( String url, String text )
	{
		...
		avatar.getElement().setAttribute( "onerror", "this.onerror=null;this.src='" + IMG_PATH + "avatar.jpg" + "';" );
		return avatar;
	}
